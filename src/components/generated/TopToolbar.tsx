    ...
    duration: 0.3
      ...
      <div className="flex items-center gap-2">
        ...
        scale: 0.95
          ...
          <Button variant="ghost" size="icon" onClick={onThemeToggle} className={cn("h-10 w-10 rounded-full", "transition-all duration-300", "hover:bg-accent hover:text-accent-foreground", "focus:ring-2 focus:ring-primary/20")} aria-label={themeMode === 'light' ? "當前：淺色模式，點擊切換到深色模式" : "當前：深色模式，點擊切換到淺色模式"}>
            <AnimatePresence mode="wait">
              {themeMode === 'light' ? <motion.div key="sun" initial={{
              rotate: -90,
              opacity: 0
            }} animate={{
              rotate: 0,
